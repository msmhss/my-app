...
function ToDo() {
    ...
    const renderCompleted = () => {
        return completed.map((complete) => (
            <ListItem>
                        <LeftContainer onClick={() => revertTask(complete.id)}>                            <CheckContainerCompleted>
                        ...
                        <ItemRightContainer>
                            <ActionButton onClick={() => revertTask(complete.id)}>
                                <ButtonImage src={require("../../assets/revert.svg").default} alt="revert"/>
                            </ActionButton>
                            <ActionButton onClick={() => deleteCompleted(complete.id)}>
                                <ButtonImage src={require("../../assets/delete.svg").default} alt="delete"/>
                            </ActionButton>
                        </ItemRightContainer>
                    </ListItem>
